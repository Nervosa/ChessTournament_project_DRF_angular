...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tournament.start_date'
        db.alter_column(u'chess_tournaments_tournament', 'start_date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Tournament.end_date'
        db.alter_column(u'chess_tournaments_tournament', 'end_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Tournament.start_date'
        db.alter_column(u'chess_tournaments_tournament', 'start_date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Tournament.end_date'
        db.alter_column(u'chess_tournaments_tournament', 'end_date', self.gf('django.db.models.fields.DateTimeField')())
