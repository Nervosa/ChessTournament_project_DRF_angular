...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Participant.elo_rating'
        db.alter_column(u'chess_tournaments_participant', 'elo_rating', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
    ...
    models = {
        ...
        u'chess_tournaments.participant': {
            ...
            'elo_rating': ('django.db.models.fields.FloatField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
